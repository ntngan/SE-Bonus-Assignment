...
WebUI.click(findTestObject('Object Repository/Page_Log in to Facebook  Facebook/input_Log in to Facebook_email'))

WebUI.setText(findTestObject('Object Repository/Page_Log in to Facebook  Facebook/input_Log in to Facebook_email'), 'mafiahuy1234@gmail.com')
...
WebUI.click(findTestObject('Object Repository/Page_ng nhp bng Facebook/span_Tip tc di tn Cung'))

WebUI.setText(findTestObject('Object Repository/Page_Create your account/input__username'), 'cung')

WebUI.click(findTestObject('Object Repository/Page_Agree to terms and conditions/input_cungmatrix.org_accepted_version'))
