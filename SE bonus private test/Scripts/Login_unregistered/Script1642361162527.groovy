...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign in to GitHub  GitHub/input_Password_password'), 'WHNKVaPPsI28Drj6IU0xYw==')
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Agree to terms and conditions/input_signup_gitmatrix.org_accepted_version'))
